...
<body>
	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<br> <br>
			<div align="left">
				<h2 class="sub-header">审核发票</h2>
			</div>
			<div align="center">
				<form action="updateselectrecept" method="post">
					<h3>
						<font color=#999999 style="margin-right: 50px">以下您选择的发票信息，请认真核实</font>
					</h3>
					<br> <font size="3px"
						style="margin-right:50px; color:#999999;">发票编号:</font><input
						type="text"
						style="margin-right: 100px;margin-bottom:20px; font-size:15px; color: #999999"
						value=<s:property value="#session.userselectrecept.recept.id"/>><br>
					<font size="3px" style="margin-right:50px; color:#999999;">图书名称:</font><input
						type="text"
						style="margin-right: 100px;margin-bottom:20px; font-size:15px; color: #999999"
						value=<s:property value="#session.userselectrecept.book.bookname"/>><br>
					<font size="3px" style="margin-right:50px; color:#999999;">购买人:</font><input
						type="text"
						style="margin-right: 100px;margin-bottom:20px; font-size:15px; color: #999999"
						value=<s:property value="#session.userselectrecept.student.sname"/>><br>
					<font size="3px" style="margin-right:50px; color:#999999;">金额:</font><input
						type="text"
						style="margin-right: 100px;margin-bottom:20px; font-size:15px; color: #999999"
						value="<s:property value='%{#session.userselectrecept.count}'/>*<s:property value='%{#session.userselectrecept.book.bookprice}'/>"><br>
					<font size="3px" style="margin-right:50px; color:#999999;">购买数量:</font><input
						type="text"
						style="margin-right: 100px;margin-bottom:20px; font-size:15px; color: #999999"
						value=<s:property value="#session.userselectrecept.count"/>><br>
					<font size="3px" style="margin-right:50px; color:#999999;">发票抬头:</font><input
						type="text"
						style="margin-right: 100px;margin-bottom:20px; font-size:15px; color: #999999"
						value=<s:property value="#session.userselectrecept.recept.beginname"/>><br>
