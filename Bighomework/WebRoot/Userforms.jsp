...
<script type="text/javascript">
        ...
        function validate()
        {
            ...
            if(page > "<s:property value='%{#request.pageBean.totalPage}'/>")
            {
                ...
                window.document.location.href = "userforms";                
                return false;
            }           
            return true;
        }    
	...
	<div class="container-fluid">
		...
		<div class="row">
				...
				<div class="table-responsive">
					<table class="table table-striped">
						<thead>
							...
							<s:iterator value="#session.userforms" var="form">
								<tr>
									...
									<s:if test="#form.c_status=='通过'&&#form.l_status=='待领取'">
										<td style="color: red">
									</s:if>
									<s:elseif test="#form.c_status=='通过'&&#form.l_status=='已领取'">
									...
									<s:property value="#form.l_status" />
									</td>


									<td><a
										href="userselectform.action?id=<s:property value="#form.id"/>"
										onclick="return lick('<s:property value="#form.c_status"/>')">领取</a></td>
            ...
            首页&nbsp;&nbsp;&nbsp;上一页
						...
						<s:else>
							<a href="userforms.action">首页</a>
            &nbsp;&nbsp;&nbsp;
            <a
								href="userforms.action?page=<s:property value="#request.pageBeanform.currentPage - 1"/>">上一页</a>
						</s:else>

						<s:if
							test="#request.pageBeanform.currentPage != #request.pageBeanform.totalPage">
							<a
								href="userforms.action?page=<s:property value="#request.pageBeanform.currentPage + 1"/>">下一页</a>
            &nbsp;&nbsp;&nbsp;
            <a
								href="userforms.action?page=<s:property value="#request.pageBeanform.totalPage"/>">尾页</a>
						</s:if>
            ...
            下一页&nbsp;&nbsp;&nbsp;尾页
					...
					<center>
						...
						<form action="userforms" onsubmit="return validate();">
