...
<script type="text/javascript">
        ...
        function validate()
        {
            ...
            if(page > "<s:property value='%{#request.pageBean.totalPage}'/>")
            {
                ...
                window.document.location.href = "showforms";                
                return false;
            }           
            return true;
        }    
	...
	<div class="container-fluid">
		...
		<div class="row">
				...
				<div class="table-responsive">
					...
					<table class="table table-striped">
						<thead>
							...
							<s:iterator value="#session.alluserforms" var="form">
								<tr>
									...
									<s:elseif test="#form.c_status=='不通过'">
										<td style="color: red">
									</s:elseif>
									<s:else>
										<td>
            ...
            首页&nbsp;&nbsp;&nbsp;上一页
						...
						<s:else>
							<a href="showforms.action">首页</a>
            &nbsp;&nbsp;&nbsp;
            <a
								href="showforms.action?page=<s:property value="#request.pageBeanform.currentPage - 1"/>">上一页</a>
						</s:else>

						<s:if
							test="#request.pageBeanform.currentPage != #request.pageBeanform.totalPage">
							<a
								href="showforms.action?page=<s:property value="#request.pageBeanform.currentPage + 1"/>">下一页</a>
            &nbsp;&nbsp;&nbsp;
            <a
								href="showforms.action?page=<s:property value="#request.pageBeanform.totalPage"/>">尾页</a>
						</s:if>
            ...
            下一页&nbsp;&nbsp;&nbsp;尾页
					...
					<center>
						...
						<form action="showforms" onsubmit="return validate();">
