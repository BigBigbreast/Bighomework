...
<body>
	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<br> <br>
			<div align="left">
				<h2 class="sub-header">购买教材</h2>
			</div>
			<div align="center">
				<form action="buybook.action" method="post" name="form1">
					<h3>
						<font color=#999999 style="margin-right: 50px">以下您选择书籍的图书信息，请认真核实</font>
					</h3>
					<br> <font size="3px"
						...
						value=<s:property value="#session.userselectbook.bookname"/>><br>
					<font size="3px" style="margin-right:50px; color:#999999;">作者:</font><input
						type="text"
						style="margin-right: 100px;margin-bottom:20px; font-size:15px; color: #999999"
						value=<s:property value="#session.userselectbook.bookwriter"/>><br>
					<font size="3px" style="margin-right:50px; color:#999999;">价格:</font><input
						type="text"
						style="margin-right: 100px;margin-bottom:20px; font-size:15px; color: #999999"
						value=<s:property value="#session.userselectbook.bookprice"/>><br>
					<font size="3px" style="margin-right:50px; color:#999999;">出版社:</font><input
						type="text"
						style="margin-right: 100px;margin-bottom:20px; font-size:15px; color: #999999"
						value=<s:property value="#session.userselectbook.bookplace"/>><br>
					<font size="3px" style="margin-right:50px; color:#999999;">剩余数量:</font><input
						type="text"
						style="margin-right: 100px;margin-bottom:20px; font-size:15px; color: #999999"
						value=<s:property value="#session.userselectbook.bookcount"/>><br>

					<font size="3px" style="margin-right:50px; color:#999999;">选择购买数量:</font>
					<select name="buybookcount"
						style="margin-right: 200px;margin-bottom:20px; font-size:15px; color: #999999">
						<option value="1">1</option>
						<option value="2">2</option>
						<option value="3">3</option>
					</select> <br> <input type="submit"
						style="margin-right: 100px;margin-bottom:20px; font-size:15px; color: #999999"
						value="提交购买"><br> <font size="4px"
