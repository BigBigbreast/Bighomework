			...
			<div align="center">
				<form action="updateform" method="post">
					...
					<br> <font size="3px"
						...
						value=<s:property value="#session.userselectform.book.bookname"/>><br>
					<font size="3px" style="margin-right:50px; color:#999999;">作者:</font><input
						type="text"
						style="margin-right: 100px;margin-bottom:20px; font-size:15px; color: #999999"
						value=<s:property value="#session.userselectform.book.bookwriter"/>><br>
					<font size="3px" style="margin-right:50px; color:#999999;">出版社:</font><input
						type="text"
						style="margin-right: 100px;margin-bottom:20px; font-size:15px; color: #999999"
						value=<s:property value="#session.userselectform.book.bookplace"/>><br>
					<font size="3px" style="margin-right:50px; color:#999999;">购买人:</font><input
						type="text"
						style="margin-right: 100px;margin-bottom:20px; font-size:15px; color: #999999"
						value=<s:property value="#session.userselectform.student.sname"/>><br>
					<font size="3px" style="margin-right:50px; color:#999999;">订单数量:</font><input
						type="text"
						style="margin-right: 100px;margin-bottom:20px; font-size:15px; color: #999999"
						value=<s:property value="#session.userselectform.count"/>><br>
					<font size="3px" style="margin-right:50px; color:#999999;">发票状态:</font><input
						type="text"
						style="margin-right: 100px;margin-bottom:20px; font-size:15px; color: #999999"
						value=<s:property value="#session.userselectform.recept.status"/>><br>
					<font size="3px" style="margin-right:50px; color:#999999;">发票抬头:</font><input
						type="text"
						style="margin-right: 100px;margin-bottom:20px; font-size:15px; color: #999999"
						value=<s:property value="#session.userselectform.recept.beginname"/>><br>


					<br> <input type="submit"
						style="margin-right: 100px;margin-bottom:20px; font-size:15px; color: #999999"
						value="确定领取"><br> <font size="4px"
