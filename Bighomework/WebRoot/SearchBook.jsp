...
<body>
	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<br> <br> <br>
			<div class="col-md-8">
				<h2 class="sub-header">搜索教材</h2>
				<div align="center">
					<h3>书名关键字查询</h3>
					<form action="searchbooks" method="post">
						关键字：<input class="form-control" style="width:50%;" type="text"
							name="keywords" /> <br> <input class="form-control"
				...
				<div class="table-responsive">
					<table class="table table-striped">
						<thead>
							...
							<s:iterator value="#session.keybooks" var="book">
								<tr>
									...
									<td><a
										href="selectbook.action?id=<s:property value="#book.id"/>">购买</a></td>
								</tr>
							</s:iterator>
						</thead>
						<tbody>
            ...
            首页&nbsp;&nbsp;&nbsp;上一页
						...
						<s:else>
							<a
								href="searchbooks.action?keywords=<s:property value="#session.keywords"/>">首页</a>
            &nbsp;&nbsp;&nbsp;
            <a
								href="searchbooks.action?page=<s:property value="#request.pageBean.currentPage - 1"/>&keywords=<s:property value="#session.keywords"/>">上一页</a>
						</s:else>

						<s:if
							test="#request.pageBean.currentPage != #request.pageBean.totalPage">
							<a
								href="searchbooks.action?page=<s:property value="#request.pageBean.currentPage + 1"/>&keywords=<s:property value="#session.keywords"/>">下一页</a>
            &nbsp;&nbsp;&nbsp;
            <a
								href="searchbooks.action?page=<s:property value="#request.pageBean.totalPage"/>&keywords=<s:property value="#session.keywords"/>">尾页</a>
						</s:if>
