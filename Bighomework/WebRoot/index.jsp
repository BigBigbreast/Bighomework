...
<body>
	...
	<div class="container-fluid">
		...
		<div class="row">
            ...
            &nbsp;&nbsp;&nbsp;
            <a
								href="lookbooks.action?page=<s:property value="#request.pageBean.currentPage - 1"/>">上一页</a>
						</s:else>

						<s:if
							test="#request.pageBean.currentPage != #request.pageBean.totalPage">
							<a
								href="lookbooks.action?page=<s:property value="#request.pageBean.currentPage + 1"/>">下一页</a>
            &nbsp;&nbsp;&nbsp;
            <a
								href="lookbooks.action?page=<s:property value="#request.pageBean.totalPage"/>">尾页</a>
						</s:if>
