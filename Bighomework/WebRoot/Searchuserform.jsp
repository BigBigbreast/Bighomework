...
<script type="text/javascript">
        ...
        function validate()
        {
            ...
            if(page > "<s:property value='%{#request.pageBean.totalPage}'/>")
            {
                ...
                window.document.location.href = "snumberforms";                
                return false;
            }           
            return true;
        }    
...
<body>
	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<br> <br> <br>
			<div class="col-md-8">
				<h2 class="sub-header">搜索购书单</h2>
				<div align="center">
					<h3>指定学号查询</h3>
					<form action="snumberforms" method="post">
						学号：<input class="form-control" style="width:50%;" type="text"
							name="snumber" /> <br> <input class="form-control"
							style="width:15%;" type="submit" value="查询" />
					</form>
				</div>
				<div class="table-responsive">
					<table class="table table-striped">
						<thead>
							...
							<s:iterator value="#session.snumberuserforms" var="form">
								<tr>
									...
									<td><a
										href="updateselectform.action?id=<s:property value="#form.id"/>"
										onclick="return lick('<s:property value="#form.c_status"/>')">审核</a></td>
            ...
            首页&nbsp;&nbsp;&nbsp;上一页
						...
						<s:else>
							<a
								href="snumberforms.action?snumber=<s:property value="#form.student.snumber"/>">首页</a>
            &nbsp;&nbsp;&nbsp;
            <a
								href="snumberforms.action?page=<s:property value="#request.pageBeanform.currentPage - 1"/>&snumber=<s:property value="#form.student.snumber"/>">上一页</a>
						</s:else>

						<s:if
							test="#request.pageBeanform.currentPage != #request.pageBeanform.totalPage">
							<a
								href="snumberforms.action?page=<s:property value="#request.pageBeanform.currentPage + 1"/>&snumber=<s:property value="#form.student.snumber"/>">下一页</a>
            &nbsp;&nbsp;&nbsp;
            <a
								href="snumberforms.action?page=<s:property value="#request.pageBeanform.totalPage"/>&snumber=<s:property value="#form.student.snumber"/>">尾页</a>
						</s:if>
