...
<body>
	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div align="center">
				<form action="updatebookcount" method="post" id="form1">
					<h3>
					...
					<br> <font size="3px"
						...
						value=<s:property value="#session.addselectbook.bookname"/>><br>
					<font size="3px" style="margin-right:50px; color:#999999;">作者:</font><input
						type="text"
						style="margin-right: 100px;margin-bottom:20px; font-size:15px; color: #999999"
						value=<s:property value="#session.addselectbook.bookwriter"/>><br>
					<font size="3px" style="margin-right:50px; color:#999999;">价格:</font><input
						type="text"
						style="margin-right: 100px;margin-bottom:20px; font-size:15px; color: #999999"
						value=<s:property value="#session.addselectbook.bookprice"/>><br>
					<font size="3px" style="margin-right:50px; color:#999999;">出版社:</font><input
						type="text"
						style="margin-right: 100px;margin-bottom:20px; font-size:15px; color: #999999"
						value=<s:property value="#session.addselectbook.bookplace"/>><br>
					<font size="3px" style="margin-right:50px; color:#999999;">剩余数量:</font><input
						type="text"
						style="margin-right: 100px;margin-bottom:20px; font-size:15px; color: #999999"
						value=<s:property value="#session.addselectbook.bookcount"/>><br>

					<font size="3px" style="margin-right:50px; color:#999999;">购买数量:</font>
					<input type="text" name="count"
						style="margin-right: 100px;margin-bottom:20px; font-size:15px; color: blue"><br>
					<br> <input type="button" id="go"
						style="margin-right: 100px;margin-bottom:20px; font-size:15px; color: #999999"
		    	...
		    	go.onclick = function(){
		        var count = loginForm.count.value
		        //这里判断了输入不能大于100
		        if(count>100){
		            //验证通过，提交表单数据
		            alert('购买书籍不能超过100');
